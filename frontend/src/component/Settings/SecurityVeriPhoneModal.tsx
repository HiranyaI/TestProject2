...
interface SecurityVeriPhoneModalProps {
  open: boolean;
  onClose: () => void;
}

const SecurityVeriPhoneModal: React.FC<SecurityVeriPhoneModalProps> = ({ open, onClose }) => {
    ...
    <Modal open={open} onClose={onClose}>
      <Box sx={modalStyle}>
        ...
        <Typography sx={{
            fontWeight: 700,
            fontSize: '20px',
            textAlign:'center'}}> 2-Step verification phone
        </Typography>
        ...
        <TextField sx={{
            ...
            label="Verification phone number here"
...
export default SecurityVeriPhoneModal;
